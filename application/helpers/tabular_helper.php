...
/*
Get the header for the branch_office tabular view
*/
function get_branch_office_manage_table_headers()
{
	$CI =& get_instance();

	$headers = array(
		array('branch_office.branch_office_id' => $CI->lang->line('common_id')),
		array('branch_office_name' => $CI->lang->line('branch_office_name'))/*,
		array('name' => $CI->lang->line('items_name')),
		array('category' => $CI->lang->line('items_category')),
		array('company_name' => $CI->lang->line('suppliers_company_name')),
		array('cost_price' => $CI->lang->line('items_cost_price')),
...
function get_branch_office_data_row($branch)
{
	...
	return array (
		...
		'edit' => anchor($controller_name."/view/$branch->branch_office_id", '<span class="glyphicon glyphicon-edit"></span>',
			array('class'=>'modal-dlg', 'data-btn-submit' => $CI->lang->line('common_submit'), 'title'=>$CI->lang->line($controller_name.'_update'))
	));
}
